...
def req_multi(n_dev):
    ...
    number = n_dev
    folder_name = "MULTI_OBJECTIVE_"+ str(dataset_n) + "-" + str(number)
...
# Crear la carpeta si no existe
    ...
    csv_filename = os.path.join(folder_name, 'api_response_data_multi.csv')
    excel_filename = 'api_response_data_multi.xlsx'
    ...
    try:
        ...
        if not os.path.exists(excel_filename):
            ...
            sheet.title = 'API Response Data Multiobjective'
